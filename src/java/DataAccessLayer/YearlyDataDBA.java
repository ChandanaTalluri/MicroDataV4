...
public class YearlyDataDBA {
     ...
     public static List find_Total_PayrollData() {
        ...
        try{
            ...
            String sql = "Select c.yearly ,c.TC_Payroll " 
                    + " from YearlyData c ";
        ...
        System.out.println("YearlyData for TC_Payroll"+strDatalist);
      ...
      public static List find_Total_WagesData() {
        ...
        try{
            ...
            String sql = "Select c.yearly ,c.TC_Wages " 
                    + " from YearlyData c ";
        ...
        System.out.println("YearlyData for TC_Wages"+strDatalist);
