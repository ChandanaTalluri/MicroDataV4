...
@Entity
@Table(name = "MFG_Wages")
public class MFG_Wages implements Serializable{
    @Id
    @Column(name="MicroAreaName")
    public String strMicroArea;
    @Column(name="StateName")
    public String strStateName;
    @Column(name="MicroAreaCode")
    public int areaCode;
    @Column(name="Years")
    public int  years;
    @Column(name="Q1")
    ...
    public MFG_Wages(String strMicroName, String strStateName ,int areaCode,int years, float Q1,float Q2,float Q3,float Q4 ){
